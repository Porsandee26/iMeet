...
<form action="meet_save.php" name="frmAdd" method="post" onSubmit="JavaScript:return fncSubmit();">
  <table width="1024" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#FFFFFF">
    ...
    <tr>
      <td height="25" colspan="6"><div align="center"><span class="style2">แบบบันทึกข้อมูลการประชุม/อบรมโรงพยาบาลสมเด็จพระสังฆราชองค์ที่ ๑๙</span></div></td>
    </tr>
    <tr>
      <td height="25">&nbsp;</td>
      <td>&nbsp;</td>
...
?>
    ...
    <tr>
      ...
      <td width="268"><div>
        <input type="text" name="txtFname" size="25" id="txtFname" class="inputs" placeholder="กรุณาใส่ชื่อของท่าน">
      </div></td>
